        ...
        <div class="col-3 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
            ...
            ?>
              ...
              <a href="pages/wishlist/wishlist.php" class="text-uppercase mx-3">Wishlist <span class="wishlist-count">(0)</span>
              </a>
            </li>
            <li class="d-none d-lg-block">
              <a href="pages/cart/cart.php" class="text-uppercase mx-3">Cart <span class="cart-count">(0)</span>
              </a>
            </li>
            <?php } else { ?>
