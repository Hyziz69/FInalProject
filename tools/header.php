        ...
        <div class="d-flex align-items-stretch col-3 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
            ...
            ?>
              ...
              <a href="wishlist/wishlist.php" class="text-uppercase mx-3 mt-6">Wishlist <span class="wishlist-count"><?php echo "(" . $wishlist->getLength() . ")" ?></span>
              </a>
            </li>

            <li class="d-none d-lg-block">
              <a href="cart/cart.php" class="text-uppercase mx-3">Cart <span class="cart-count"><?php echo "(" . $cart_length . ")" ?></span>
              </a>
            </li>
            ...
            <li class="d-none d-lg-block ">
              <div class="d-flex flex-row-reverse align-items-center">
                <a href="#" class="btn btn-transparent mx-5" data-bs-toggle="modal" data-bs-target="#authModal">Login / Register</a>

                <?php if(isset($_SESSION['alert'])){ ?>
                            
                  <div class=" bg-warning w-5 mt-4 rounded bg-danger-subtle mb-4 alert-<?=$_SESSION['alert']['type'] ?>">
            ...
            <div class="modal-body">
                ...
                <form id="registerForm" style="display: none;" action="registerLogic.php" method="POST">
                    <div class="mb-3">
                        <label for="registerEmail" class="form-label">First name</label>
                        <input type="text" name="first_name" class="form-control" id="registerEmail" required>
                    </div>
                    <div class="mb-3">
